...
import { demoInsuranceObjectsService } from '@/services/demo-insurance-objects';

export function DemoInsuranceTester() {
  ...
  const handleCreateObject = async () => {
    ...
    try {
      console.log('🎯 Début du test de création d\'objet de démonstration...');
      
      const result = await demoInsuranceObjectsService.createDemoInsuranceObject(
      ...
      console.log('✅ Objet de démonstration créé avec succès:', result);
    } catch (err: any) {
    ...
    return (
      <Card className="border-green-200 bg-green-50">
        <CardHeader>
          ...
          <CardDescription>
            Votre objet d'assurance de démonstration a été créé et stocké localement
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              <strong>Version de démonstration :</strong> Cet objet est stocké localement pour la démonstration. 
          ...
          <div className="p-4 bg-white rounded-lg border">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-semibold text-sm text-gray-700">Objet d'Assurance (Démo)</h4>
          ...
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div><strong>Type de risque:</strong> {demoInsuranceObjectsService.getRiskTypeLabel(createdObject.riskType)}</div>
              <div><strong>Statut:</strong> {demoInsuranceObjectsService.getStatusLabel(createdObject.status)}</div>
            </div>
          </div>
